...
{
    const CONSUMER_KEY = 'vUrQrZL50m7qL3uosytRJbeW8fzSwUqd'; // please replace YOUR_XX
    const CONSUMER_SECRET = 'vUrQrZL50m7qL3uosytRJbeW8fzSwUqd'; // please replace YOUR_XX
