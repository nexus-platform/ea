...
$(function () {
    ...
    $('#install').click(function () {
        ...
        var url = GlobalVariables.baseUrl + '/index.php/installation/ajax_install?XDEBUG_SESSION_START=netbeans-xdebug';
        var data = {
        ...
        $.ajax({
            ...
            .done(function (response) {
                ...
                if (response === "SUCCESS") {
                    alert('Easy!Appointments has been successfully installed!');
                    $('#install').hide();
                }
                $alert
